            ...
            <form action="{{ route('berita-update', $berita->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <img src="{{ asset('img/berita/'.($berita->foto ?? 'user.png')) }}" width="110px"
                        class="image img" />
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul" name="judul" value="{{ old('judul') ?? $berita->judul }}"  placeholder="Enter ">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="aktif" id="" class="form-control @error('aktif') is-invalid @enderror">
                            <option value="Ya" {{ $berita->aktif == 'Ya' ? 'selected' : '' }}>Ya</option>
                            <option value="No" {{ $berita->aktif == 'No' ? 'selected' : '' }}>No</option>
                        </select>
...
@if($berita->isi_berita != null)
    $('#summernote').summernote('code','<?php echo $berita->isi_berita; ?>');
@else
