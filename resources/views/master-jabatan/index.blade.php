      ...
      <div class="card-header bg-gray1" style="border-radius:10px 10px 0px 0px;">
        <div class="row">
          ...
          <div class="col-6 d-flex justify-content-end">
            <a href="{{ route('master-jabatan-create') }}" class="btn btn-md btn-info">
          ...
          <tbody>
            ...
            @foreach ($jabatan as $item)
              <tr>
                ...
                <td>
                  <div class="btn-group">
                    <a href="{{ route('master-jabatan-edit', $item->id) }}" class="btn btn-warning text-white">
                      <i class="far fa-edit"></i>
                      Edit
                    </a>
                    <a href="{{ route('master-jabatan-destroy', $item->id) }}" class="btn btn-danger f-12">
