      ...
      <div class="card-header bg-gray1" style="border-radius:10px 10px 0px 0px;">
        <div class="row">
          ...
          <div class="col-6 d-flex justify-content-end">
            <a href="{{ route('master-rw-create') }}" class="btn btn-md btn-info">
          ...
          <tbody>
            ...
            @foreach ($rw as $item)
              <tr>
                ...
                <td>
                  <div class="btn-group">
                    <a href="{{ route('master-rw-edit', $item->id) }}" class="btn btn-warning text-white">
                      <i class="far fa-edit"></i>
                      Edit
                    </a>
                    <a href="{{ route('master-rw-destroy', $item->id) }}" class="btn btn-danger f-12">
